...
class InspectionMethodCandidateManifestTest(unittest.TestCase):
    def test_manifest_separates_promoted_traces_from_verification_queue(self):
        ...
        self.assertIn("historical blood_pressure关系不能扩展到其余24个β阻滞剂", bjs_202502["correction_note"])
        self.assertIn("CAS 36507-48-9与57775-29-8", bjs_202502["correction_note"])
        self.assertIn("source-level discrepancy", bjs_202502["correction_note"])
