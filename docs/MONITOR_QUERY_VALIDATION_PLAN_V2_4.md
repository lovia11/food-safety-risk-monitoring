...
> Status: **COMPLETE — planned standard-name waves and governed 食用百合 refinement reviewed**
>
> Completed collection/review batches: Wave 1 `v2-4b-batch-01a`, Wave 2A `v2-4b-batch-02a`, Wave 2B `v2-4b-batch-02b`, Lily refinement `v2-4b-batch-02c`
>
...
Wave 1 decisions and immutable manifest evidence are recorded in [MONITOR_QUERY_VALIDATION_RESULTS_V2_4_BATCH_01A.md](MONITOR_QUERY_VALIDATION_RESULTS_V2_4_BATCH_01A.md). Wave 2A is recorded in [MONITOR_QUERY_VALIDATION_RESULTS_V2_4_BATCH_02A.md](MONITOR_QUERY_VALIDATION_RESULTS_V2_4_BATCH_02A.md), Wave 2B in [MONITOR_QUERY_VALIDATION_RESULTS_V2_4_BATCH_02B.md](MONITOR_QUERY_VALIDATION_RESULTS_V2_4_BATCH_02B.md), and the independently revalidated 百合 refinement in [MONITOR_QUERY_VALIDATION_RESULTS_V2_4_BATCH_02C.md](MONITOR_QUERY_VALIDATION_RESULTS_V2_4_BATCH_02C.md).
...
- Lifecycle: enabled `search_validated`
- Collection batch: `v2-4b-batch-02c`
- Collection status: complete, 15 unique Search Result cards
- Human-review result: 10 assessable, 9 relevant, 1 raw medicinal/non-food scope, 1 ambiguous skipped, 90% observed relevance, `promote`

The completed review promotes `食用百合` without changing MonitorTarget identity or rehabilitating the rejected standard-name Query. 百合 is operational only through the refined strategy; the naked `百合` Query remains disabled and retains its Batch 02B history.
